(function() {
  ...
  Annotator = (function() {
    ...
    Annotator.prototype.createAnnotation = function(annotation) {
      ...
      a.ranges = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push(serialized = sniffed.serialize(this.wrapper, '.annotator-hl'));
        }
        return _results;
      }).call(this);
    ...
    Annotator.prototype.hideEditor = function() {
      ...
      return $(this.element).trigger('annotationEditorHidden', [this.dom.editor]);
    };
    Annotator.prototype.processEditorKeypress = function(e) {
      if (e.keyCode === 27) {
        return this.hideEditor();
      } else if (e.keyCode === 13 && !e.shiftKey) {
        return this.submitEditor();
      }
    };
