(function() {
  ...
  Annotator.Plugins.Markdown = (function() {
    ...
    Markdown.prototype.updateViewer = function(e, viewerElement, annotations) {
      ...
      textContainers = $(viewerElement).find('.' + this.annotator.componentClassname('annotation-text'));
      _results = [];
      for (_i = 0, _len = textContainers.length; _i < _len; _i++) {
        t = textContainers[_i];
        ann = $(t).parents('.' + this.annotator.componentClassname('annotation')).data('annotation');
