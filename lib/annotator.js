...
this.AnnotationStore = DelegatorClass.extend({
    events: {
        'annotationCreated': 'createAnnotation'
    },
    ...
    init: function (options, element) {
        ...
        this.options = $.extend({
            ...
            urls: {
               ...
               'read': 'annotation/:id',   // GET
               'update': 'annotation/:id', // PUT
               'destroy': 'annotation/:id' // DELETE
            },
    ...
    createAnnotation: function (e, annotator, newAnnotation) {
        $.ajax({
    ...
    loadAnnotation: function (id) {
        ...
        $.getJSON(this._urlFor('read', id), null, function (data, textStatus) {
            if (textStatus === 'success') {
                self.options.annotator.loadAnnotations([data]);
            } else {
